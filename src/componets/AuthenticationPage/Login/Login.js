...
const Login = () => {
    ...
    return (
        ...
        className='h-[800px] flex justify-center items-center md:flex-row flex-col '>
            <div className=''>
                <img className=' rounded-lg md:w-[400px] w-full h-96 mx-auto  ' src={bg} alt="" />
            </div>
            ...
            <div className=' p-7'>
                <div className=''>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)}>
                        ...
                        <input className='btn btn-accent w-full mt-5 bg-gradient-to-r from-sky-500 to-indigo-500 text-2xl ' value='Login' type="submit" />
                        <div>
                    ...
                    <button onClick={handleGoogle} className='btn border-0 uppercase w-full bg-gradient-to-r from-purple-500 to-pink-500   '> <FaGoogle className='text-2xl text-black mr-2'></FaGoogle> Continue With Google</button>
