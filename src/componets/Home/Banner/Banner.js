    ...
    return (
        <section className="py-3   dark:text-gray-50">
            <div className="container shadow-lg grid grid-cols-2 gap-2 p-2 mx-auto md:grid-cols-4">
                ...
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square object-cover" src={phone1} />
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square object-cover" src={phone2} />
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square object-cover" src={phone3} />
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square object-cover" src={phone5} />
